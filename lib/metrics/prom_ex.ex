defmodule Metrics.PromEx do
  ...
  def plugins do
    [
      ...
      Plugins.Application,
      Plugins.Beam
      # {Plugins.Phoenix, router: MetricsWeb.Router, endpoint: MetricsWeb.Endpoint},
      # Plugins.Ecto,
      # Plugins.Oban,
  ...
  def dashboards do
    [
      ...
      # {:metrics, "/grafana_dashboards/user_metrics.json"}
    ]
  end
end
